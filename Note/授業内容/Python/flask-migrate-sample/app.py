...
# ターミナル
# PS G:\その他のパソコン\マイ コンピュータ\MyRepository\Note\授業内容\Python\flask-migrate-sample> 

# 初期化
# migrationsファイルが作られる
# flask db init

# マイグレーションスクリプト？が作成される
# flask db migrate -m "コメント"

# taskテーブルを作成
# flask db migrate -m "create tasks table"
# task テーブルに、is_completed というカラムを追加
# flask db migrate -m "Add is_completed column to tasks table"
